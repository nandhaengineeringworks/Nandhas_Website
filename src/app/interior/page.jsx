...
import { Layers, ChevronRight, Sparkles, Send, Check } from 'lucide-react';
        ...
        {currentBanner && (
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl min-h-[220px] xs:min-h-[260px] sm:min-h-[400px] flex items-center">
            ...
            <div className="absolute inset-0 z-0">
              <picture>
                <source media="(max-width: 640px)" srcSet={currentBanner.mobileImageUrl || currentBanner.desktopImageUrl || currentBanner.imageUrl} />
                <source media="(max-width: 1024px)" srcSet={currentBanner.tabletImageUrl || currentBanner.desktopImageUrl || currentBanner.imageUrl} />
              ...
              {features.length > 0 && (
                <div className="hidden sm:flex flex-wrap gap-2 pt-1">
                  {features.map((feat, idx) => (
                    ...
                    >
                      <Check className="w-3.5 h-3.5 text-trust-green mr-1.5 shrink-0" />
                      {feat}
                    </span>
                  ))}
                </div>
