...
export default function StickyActions() {
  return (
    <>
      ...
      <div className="fixed bottom-5 right-4 sm:bottom-7 sm:right-7 z-40 flex flex-col gap-3">
        ...
        <a
          ...
          className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-emerald-500/30 transition-all duration-200 hover:scale-105 hover:bg-[#1ebe5d]"
        ...
        <a
          ...
          className="group flex h-14 w-14 items-center justify-center rounded-full bg-navy-800 text-white shadow-xl shadow-navy-900/30 transition-all duration-200 hover:scale-105 hover:bg-navy-700"
