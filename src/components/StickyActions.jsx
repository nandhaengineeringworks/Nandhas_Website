...
export default function StickyActions() {
  return (
    <>
      {/* Floating Call & WhatsApp Action FABs — Positioned perfectly above mobile BottomNav */}
      <div className="fixed bottom-[74px] right-3.5 sm:bottom-20 sm:right-5 lg:bottom-6 lg:right-6 z-30 flex flex-col gap-2.5 sm:gap-3">
        {/* WhatsApp Direct Chat FAB */}
        <a
          ...
          className="group relative flex h-12 w-12 sm:h-13 sm:w-13 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-emerald-500/35 transition-all duration-200 hover:scale-110 active:scale-95 hover:bg-[#1ebe5d]"
        ...
        >
          ...
          <svg viewBox="0 0 24 24" aria-hidden="true" className="relative h-5 w-5 sm:h-6 sm:w-6 fill-current">
        ...
        <a
          ...
          className="group flex h-12 w-12 sm:h-13 sm:w-13 items-center justify-center rounded-full bg-navy-800 text-white shadow-lg shadow-navy-950/40 transition-all duration-200 hover:scale-110 active:scale-95 hover:bg-navy-700 border border-navy-700"
          title="Direct Phone Call - Prahalad Nandha"
          aria-label="Call Prahalad Nandha"
        >
          <Phone className="h-4.5 w-4.5 sm:h-5 sm:w-5 text-amber-400" />
        </a>
      </div>
    </>
  );
